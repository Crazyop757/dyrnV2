...
const INTENT_COLORS: Record<string, { stroke: string; text: string; bg: string }> = {
  "Builds Upon":       { stroke: "#10b981", text: "text-emerald-300", bg: "bg-emerald-950/90 border-emerald-700" },
  "Applies Method":    { stroke: "#3b82f6", text: "text-blue-300",    bg: "bg-blue-950/90 border-blue-700" },
  "Refutes":           { stroke: "#ef4444", text: "text-red-300",     bg: "bg-red-950/90 border-red-700" },
  "Similar Research":  { stroke: "#a78bfa", text: "text-violet-300",  bg: "bg-violet-950/90 border-violet-700" },
  "General Reference": { stroke: "#71717a", text: "text-zinc-300",    bg: "bg-zinc-800/90 border-zinc-600" },
};
  ...
  return (
    <>
      ...
      <path
        ...
        strokeWidth={isSimilar ? 1.5 : hovered ? 3.5 : 2}
        strokeOpacity={isSimilar ? 0.25 : hovered ? 1 : 0.6}
      ...
      {hovered && !isSimilar && (
        <EdgeLabelRenderer>
          ...
          >
            ...
            {showContext && context && (
              <div
                className="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-64 p-3 rounded-xl shadow-2xl z-[200]"
                style={{ background: "#111113", border: "1px solid #2a2a2e" }}
              >
                <div className="flex justify-between items-center mb-2">
                  <span className="text-[10px] font-semibold text-zinc-300">Citation context</span>
                  <button
